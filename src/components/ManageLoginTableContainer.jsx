...
export default function ManageLoginTableContainer({ data, rowsPerPage }) {
        ...
        <TableBody>
          {currentData.map((row, index) => (
            ...
            >
              ...
              <TableCell className="text-center">{row.browserOs}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
