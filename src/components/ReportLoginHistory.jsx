import ManageLoginTableContainer from "@/components/ManageLoginTableContainer";
...
export default function PendingBets() {
  ...
  const [searchedData, setSearchedData] = useState(LoginData);
  ...
  function handleSearchedData(currentSearch) {
    ...
    const searched = LoginData.tableRows.filter((row) => {
  ...
  return (
    <div className="space-y-10 px-6 py-12">
      <div className="flex w-full flex-col gap-5 md:flex-row md:items-center md:justify-between md:gap-0">
        <h3 className="text-xl font-bold text-gray-700">User Login History</h3>
