import ManageNotificationTableContainer from "@/components/ManageNotificationTableContainer";
...
export default function ReportNotificationHistory() {
  const [searchTerm, setSearchTerm] = useState("");
  const [searchedData, setSearchedData] = useState(NotificationsData);
  ...
  function handleSearchedData(currentSearch) {
    ...
    const searched = NotificationsData.tableRows.filter((row) => {
  ...
  return (
    <div className="space-y-10 px-6 py-12">
      <div className="flex w-full flex-col gap-5 md:flex-row md:items-center md:justify-between md:gap-0">
        <h3 className="text-xl font-bold text-gray-700">Notification History</h3>
      ...
      <div className="bg-white">
        <ManageNotificationTableContainer
          data={
