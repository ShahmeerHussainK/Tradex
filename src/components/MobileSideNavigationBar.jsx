  ...
  return (
    <Drawer open={isOpen} onOpenChange={setIsOpen} direction="left">
      ...
      <DrawerContent
        ...
        className="custom-scrollbar flex h-full w-full flex-col items-start gap-4 bg-indigo-950 p-6 text-white"
      >
        ...
        <div className="w-full">
          <DrawerTitle className="p-3 text-sm font-semibold text-indigo-200">
            BET SETUP
          </DrawerTitle>
          <div className="w-full">
            <ResueableAccordion
